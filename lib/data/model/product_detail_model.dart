...
class ProductDetail {
  ...
  ProductDetail.fromXml(XmlElement e) {
    asDetail = e.findElements('asDetail').isEmpty ? '' : e.findElements('asDetail').first.text;

    htmlDetail = e.findElements('htmlDetail').isEmpty ? '' : e.findElements('htmlDetail').first.text;

    prdImage01 = (e.findElements('prdImage01').isEmpty ||
            e.findElements('prdImage01').first.text == 'http://image.elevenia.co.id/g/0/2/2/6/9/6/no_image_300.gif')
        ? 'https://png.pngtree.com/png-vector/20190820/ourmid/pngtree-no-image-vector-illustration-isolated-png-image_1694547.jpg'
        : e.findElements('prdImage01').first.text;
    prdImage02 = e.findElements('prdImage02').isEmpty ||
            e.findElements('prdImage02').first.text == 'http://image.elevenia.co.id/g/0/2/2/6/9/6/no_image_300.gif'
        ? 'https://png.pngtree.com/png-vector/20190820/ourmid/pngtree-no-image-vector-illustration-isolated-png-image_1694547.jpg'
        : e.findElements('prdImage02').first.text;
    prdImage03 = e.findElements('prdImage03').isEmpty ||
            e.findElements('prdImage03').first.text == 'http://image.elevenia.co.id/g/0/2/2/6/9/6/no_image_300.gif'
        ? 'https://png.pngtree.com/png-vector/20190820/ourmid/pngtree-no-image-vector-illustration-isolated-png-image_1694547.jpg'
        : e.findElements('prdImage03').first.text;
    prdImage04 = e.findElements('prdImage04').isEmpty ||
            e.findElements('prdImage04').first.text == 'http://image.elevenia.co.id/g/0/2/2/6/9/6/no_image_300.gif'
        ? 'https://png.pngtree.com/png-vector/20190820/ourmid/pngtree-no-image-vector-illustration-isolated-png-image_1694547.jpg'
    ...
    prdWght = e.findElements('prdWght').isEmpty ? '' : e.findElements('prdWght').first.text;
    ...
    dispCtgrNo1 = e.findElements('dispCtgrNo1').isEmpty ? '' : e.findElements('dispCtgrNo1').first.text;
    ...
    productOption = e.findElements('ProductOptionDetails').isEmpty
        ...
        : ProductOptionDetails.fromXml(e.findElements('ProductOptionDetails').first);
    updateDt =
        e.findElements('updateDt').isEmpty ? DateTime.now() : DateTime.tryParse(e.findElements('updateDt').first.text);
  }
